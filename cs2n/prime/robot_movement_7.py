...
# Topic: lesson - big idea: planning and behaviors
# URL: https://www.cs2n.org/u/mp/badge_pages/2779
# Source: cs2n.org — Coding and Computational Thinking with LEGO SPIKE Prime (3.0)
import runloop
from hub import port
import motor_pair

# Short: Shows planning and behavior through a sequence of moves.
...
async def main():
    ...
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, get_degree_from_distance(30), 0, velocity=360)
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, int(0.45*360), 100)
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, get_degree_from_distance(75), 0, velocity=360)
