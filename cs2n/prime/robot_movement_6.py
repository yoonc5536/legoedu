...
# Topic: Mini-challenge: steer around the crater
# URL: https://www.cs2n.org/u/mp/badge_pages/3122
# Source: cs2n.org — Coding and Computational Thinking with LEGO SPIKE Prime (3.0)
import runloop
from hub import port
import motor_pair

# Short: Another mini challenge to navigate around an obstacle.
...
async def main():
    ...
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, get_degree_from_distance(35), 0, velocity=360)
